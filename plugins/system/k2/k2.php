...
class plgSystemK2 extends JPlugin
{
	...
	function onAfterDispatch()
	{
		...
		if (($option == 'com_user' && $view == 'register') || ($option == 'com_users' && $view == 'registration'))
		{
			...
			$initialsFieldName = K2_JVERSION != '15' ? 'jform[initials]' : 'initials';
			$view->assignRef('initialsFieldName', $initialsFieldName);
			$universityFieldName = K2_JVERSION != '15' ? 'jform[university]' : 'university';
			$view->assignRef('universityFieldName', $universityFieldName);
			$regnumberFieldName = K2_JVERSION != '15' ? 'jform[regnumber]' : 'regnumber';
			$view->assignRef('regnumberFieldName', $regnumberFieldName);
			$facultyFieldName = K2_JVERSION != '15' ? 'jform[faculty]' : 'faculty';
			$view->assignRef('facultyFieldName', $facultyFieldName);
