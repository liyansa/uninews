...
<form action="<?php echo JURI::root(true); ?>/index.php" enctype="multipart/form-data" method="post" id="josForm" name="josForm" class="form-validate">
	...
	<div id="k2Container" class="k2AccountPage">
		<table class="admintable" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td class="key">
					<label id="initialsmsg" for="initials"><?php echo JText::_('K2_INITIALSNAME'); ?></label>
				</td>
				<td>
					<input type="text" name="<?php echo $this->initialsFieldName; ?>" id="initials" size="40" value="<?php echo $this->escape($this->user->get( 'initials' )); ?>" class="inputbox required" maxlength="50" />
					*
				</td>
			</tr>
			<tr>
				<td class="key">
					<label id="universitymsg" for="university"><?php echo JText::_('K2_UNIVERSITYNAME'); ?></label>
				</td>
				<td>
					<select type="list" name="<?php echo $this->universityFieldName; ?>" id="university" value="<?php echo $this->escape($this->user->get( 'university' )); ?>" class="inputbox required" >
					<option value="unijaffna">University of Jaffna</option>
					</select>
					*
				</td>
			</tr>
			<tr>
				<td class="key">
					<label id="facultymsg" for="faculty"><?php echo JText::_('K2_FACULTYNAME'); ?></label>
				</td>
				<td>
					<select type="list" name="<?php echo $this->facultyFieldName; ?>" id="faculty" value="<?php echo $this->escape($this->user->get( 'faculty' )); ?>" class="inputbox required" >
					<option value="sciencefaculty">Science Faculty</option>
					</select>
					*
				</td>
			</tr>
			<tr>
				<td class="key">
					<label id="regnumbermsg" for="regnumber"><?php echo JText::_('K2_REGNUMBERNAME'); ?></label>
				</td>
				<td>
					<input type="text" name="<?php echo $this->regnumberFieldName; ?>" id="regnumber" size="40" value="<?php echo $this->escape($this->user->get( 'regnumber' )); ?>" class="inputbox required" maxlength="50" />
					*
				</td>
			</tr>
			<tr>
		...
		<table>
		<tr>
            <td><input type="checkbox" id="terms" name="terms" value="terms" onclick="checktermsbox();" style="margin-left:3px;margin-top:3px;" class="checkbox required validate-terms"/> <label for="terms"><?php echo JText::_( 'I Agree to the Terms' ); ?></label>
             <span> <a href="<?php echo JRoute::_( 'terms-of-service.html' ); ?>" target="_blank">
		<?php echo JText::_('Terms of Agreement'); ?></a>
        </span></td>
	    </tr>
		</table>
